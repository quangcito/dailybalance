...
Your Task:
- Review the Reasoning Output (insights, suggestions, warnings, derivedData) and the Conversation History.
...
- Output ONLY a JSON object matching the StructuredAnswer interface: { text: string, suggestions?: string[], dataSummary?: Record<string, any> }. Do not include any other text or explanations outside the JSON structure.
    - Ensure the 'text' field contains the main conversational response.
    - Populate 'suggestions' if relevant suggestions were generated by the reasoning layer.
    - **Crucially, populate the 'dataSummary' field using the information provided in the 'derivedData' field from the Reasoning Output.**
